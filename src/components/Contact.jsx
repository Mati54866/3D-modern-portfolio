...
const emailJsConfig = {
  ...
  toName: import.meta.env.VITE_APP_EMAILJS_TO_NAME,
  toEmail: import.meta.env.VITE_APP_EMAILJS_TO_EMAIL,
};
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const { serviceId, templateId, publicKey, toName, toEmail } = emailJsConfig;
